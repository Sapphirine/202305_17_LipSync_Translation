...
# New method for sending data to kafka
...
# Change with the updated file name for confluent injection
producer = Producer(read_ccloud_config('/content/sample_data/client.properties'))
...
def convert(audio_file, video_file, checkpoint_path, final_output_directory):
    ...
    for i, (img_batch, mel_batch, frames, coords) in enumerate(tqdm(gen,
        ...
        for p, f, c in zip(pred, frames, coords):
            ...
            hm ={'key' : iter, 'message':frame_bytes }
            producer.produce("frames", key=str(iter), value=frame_bytes)
